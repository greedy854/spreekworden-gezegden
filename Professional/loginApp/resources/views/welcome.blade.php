        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    ...
                    <div class="relative flex items-center gap-6 lg:items-end">
                        <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                            ...
                            <div class="pt-3 sm:pt-5 lg:pt-0">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Welkom op de main page!
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Wilt u inloggen of een account maken kijk rechtsboven!
                                </p>
                            </div>
                        </div>
                    ...
                    <a href="" "link naar de about us page"
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">De Website!</h2>
                    ...
                    <a href="" "link naar de about us page"
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Over ons</h2>

                            <p class="mt-4 text-sm/relaxed">
                                >
                                Welkom bij de Spreekwoorden en Gezegde Tool: Sprekende Spreuken/Proverbs Paradise!
                                We helpen je op een leuke manier meer te leren over Nederlandse spreekwoorden en
                                gezegdes,
                    ...
                    <div
                        ...
                        <a href="">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Contact</h2>
