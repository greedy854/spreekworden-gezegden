        ...
        <div className="card">
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              <h2>Rest</h2>
              <p>A: Isis Pankeet </p>
              <p>B: Thomas Pallarés Sikkes </p>
              <p>B: Yuna Tydall</p>
              <p>C: Mandy Rasenberg </p>
              <p>D: Anna Seijsener </p>
              <p>E: Femke Klomp </p>
              <p>F: Yuna Tydall </p>
              <p>G: Maan Dekker 1-20 </p>
              <p>G: Rayan Fari 21 – ….. </p>
              <p>H: Anna Seijsener 1-37 </p>
              <p>I: Femke Klomp </p>
              <p>M: Cheverney Adams </p>
              <p>M: Vanja Jakovljevic 161-322 </p>
